...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 24 2024 г., 06:07
...
(7, 'Максимов Максим Максимович', 'Magic228@mail.com', '89276233435', 'Ремонт смартфонов OC Android', 'Poco ', 'y5', 'Сломался телефон! Памагите!'),
(8, 'Ильминский владислав денисович', 'Redaktorfilm@yandex.ru', '89276221453', 'Ремонт другой электроники', 'Наушники logitech', 'fs-102', 'перестали работать динамики');
...
(10, 'Максим', 'Magic228@mail.com', '25f9e794323b453885f5181f1b624d0b'),
(11, 'vladislav.ilminskiy', 'redaktorfilm@yandex.ru', 'c4ca4238a0b923820dcc509a6f75849b');
...
--
ALTER TABLE `Clients`
  MODIFY `ID_Клиента` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

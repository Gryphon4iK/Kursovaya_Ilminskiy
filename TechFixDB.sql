...
--
-- Хост: 127.0.0.1:5565
-- Время создания: Июн 17 2024 г., 16:45
...
(1, 'Амаль Азатович Байсаров', 'Amal@mail.ru', '789949461', 'Ремонт настольных компьютеров', 'gggg', 'ggggg', 'ggggggg'),
(2, 'Амаль Азатович Байсаров', 'Amal@mail.ru', '789949461', 'Ремонт настольных компьютеров', 'ffsfsfs', 'fsffffsfsfsv', 'fsfffsfs'),
(3, 'Иван Иванович Иванов', 'Amal@mail.ru', '8924642264', 'Ремонт смартфонов OC Android', 'Sonic Php', 'S250Z', 'Сломался'),
(4, 'Амаль Азатович Байсаров', 'Amal@mail.ru', '789949461', 'Ремонт ноутбуков', '555', '555', '555'),
(5, 'Пенис Большой хуй', 'bolshoy.huy.yayca@mail.ru', '88005553535', 'Ремонт другой электроники', 'фен daison', 'ebu-1080', 'Почему вместо того чтобы выдувать воздух он всасывает его, думаю мне продали не фен а дилдо');
...
(5, 'Kakashi', 'NarutoUzumaki228@yandex.ru', '25f9e794323b453885f5181f1b624d0b'),
...
(1, 'ул. Пушкина, д. Колотушкино', 899945566, 'TechFix@mail.com', 'Сервисный центр. Сервисный центр. Сервисный центр. Сервисный центр. Сервисный центр. Сервисный центр.'),
(2, 'ул. Абхазная, д.135/14, стр.1', 76413344, 'TechFixSup@gmail.com', 'Техническая поддержка');
...
CREATE TABLE `Сотрудники` (
  ...
  `Контактный телефон` int NOT NULL,
  `Домашний адрес` varchar(255) NOT NULL,
...
INSERT INTO `Сотрудники` (`ID_Сотрудника`, `ID_Предприятия`, `ФИО`, `Контактный телефон`, `Домашний адрес`, `Должность`) VALUES
...
--
ALTER TABLE `Clients`
  MODIFY `ID_Клиента` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
